...
<html lang="en">
  ...
  body{
    background: url(unmer.jpg) no-repeat;
        ...
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <a class="navbar-brand font-weight-bold text-monospace" href="?z=beranda">HALAMAN OLAH DATA</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-dark font-weight-bold text-monospace" href="?z=KELUAR">LOGOUT</a>
                        </li>
                        </ul>
                    </div>
                </nav>
         ...
         <div class="row mt-3">
            <div class="col-md-4">
                ...
                <ul class="list-group list-group-flush bg-dark">
                    <li class="list-group-item">Unmer Malang</li>
                    <li class="list-group-item">Unmer Malang</li>
                    <li class="list-group-item">Unmer Malang</li>
                    <li class="list-group-item">Unmer Malang</li>
                </ul>
            ...
            <div class="row mt-4 mx-auto">
                <div class="col-md-12">
                    <p class="text-center font-weight-bold">LeonardGalur &copy; 2022</p>
                </div>
            </div>
        </div>
    </div>
