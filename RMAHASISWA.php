...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <h3 class="font-weight-bold text-monospace text-center text-blue">LAPORAN DATA MAHASISWA</h3>
    <table class="mt-2 table table-dark table-hover">
        <thead>
    ...
    <a href="CRMAHASISWA.php" target="blank" class="btn btn-dark font-weight-bold text-monospace">LIHAT & DOWNLOAD DATA MAHASISWA</a>
